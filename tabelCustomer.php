...
<body>
    ...
    <a href="tabelCustomer.php?action=tambah" class="btn btn-info">
    ...
    <div class="form-edit" <?php if ($clasShow === false) { ?>style="display:none" <?php } ?>>
        ...
        <form action="" method="POST">
            ...
            <a href="tabelCustomer.php" class="btn btn-info">
    ...
    <table id="dataTable" cellspacing="0" class="table">
        <thead class="table-dark">
            <tr>
                <th>Id Customer</th>
                <th><a href="tabelCustomer.php?column=nama&order=<?php echo $asc_or_desc; ?>">Nama<i class="fas fa-sort<?php echo $column == 'nama_customer' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                <th>Email</th>
                <th><a href="tabelCustomer.php?column=gender&order=<?php echo $asc_or_desc; ?>">Jenis Kelamin<i class="fas fa-sort<?php echo $column == 'gender' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                <th>Alamat</th>
                <th>Tanggal</th>
                <th>Telepon</th>
                <th>Course</th>
                <th>Portfolio</th>
                <th><a href="tabelCustomer.php?column=saldo&order=<?php echo $asc_or_desc; ?>">Saldo<i class="fas fa-sort<?php echo $column == 'saldo' ? '-' . $up_or_down : ''; ?>"></i></a></th>
                <th>Aksi</th>
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td> <?php echo $data['id_portofolio']; ?> </td>
                    <td> <?php echo $data['saldo']; ?> </td>
                    <td>
                        <a href="tabelCustomer.php?action=edit&id=<?php echo $data['id_customer']; ?>" class="btn btn-warning btn-icon-split">
                            <span class="icon text-white-50">
                                <i class="fas fa-exclamation-triangle"></i>
                            </span>
                            <span class="text">Edit</span>
                        </a>
                        <a href="tabelCustomer.php?action=delete&id=<?php echo $data['id_customer']; ?>" class="btn btn-danger btn-icon-split">
                            <span class="icon text-white-50">
